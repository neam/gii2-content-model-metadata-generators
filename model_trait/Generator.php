...
namespace neam\gii2_content_model_metadata_generators\model_trait;
...
class Generator extends \neam\gii2_content_model_metadata_generators\ContentModelMetadataGenerator
{
     ...
     */
    public $templates = [
        'yii' => '@vendor/neam/gii2-content-model-metadata-generators/model_trait/yii',
        'yii2' => '@vendor/neam/gii2-content-model-metadata-generators/model_trait/yii2',
    ];
